...
public class RegisterActivity extends AppCompatActivity {
    ...
    //set all xml content to java
        ...
        //register event click (checking if all content is correct)
    ...
    //sending to function and create new user in realtime database + authenthication
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    String UIDAUTHOR = firebaseUser.getUid();
                        ...
                        //connect to firebase and create user
